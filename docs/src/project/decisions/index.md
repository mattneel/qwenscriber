...
Architecture decision records capture durable choices that affect multiple components or future
compatibility.

| ADR | Decision | Status |
| --- | --- | --- |
| [0001](0001-runtime-boundaries.md) | TypeScript/Zig/WGSL ownership boundaries | Accepted |
